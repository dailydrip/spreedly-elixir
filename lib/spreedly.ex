defmodule Spreedly do
  ...
  @spec store_payment_method(Environment.t(), String.t(), String.t()) ::
          {:ok, any} | {:error, any}
  def store_payment_method(env, gateway_token, payment_method_token) do
    post_request(
      env,
      store_payment_method_path(gateway_token),
      store_payment_method_body(payment_method_token)
    )
  end
  ...
  """
  @spec verify(Environment.t(), String.t(), String.t(), String.t() | nil, Keyword.t()) ::
          {:ok, any} | {:error, any}
  def verify(env, gateway_token, payment_method_token, currency_code \\ nil, options \\ []) do
    post_request(
      env,
      verify_path(gateway_token),
      verify_body(payment_method_token, currency_code, options)
    )
  end
  ...
  """
  @spec list_payment_method_transactions(Environment.t(), String.t(), Keyword.t()) ::
          {:ok, any} | {:error, any}
  ...
  """
  @spec list_gateway_transactions(Environment.t(), String.t(), Keyword.t()) ::
          {:ok, any} | {:error, any}
  ...
  defp transcript_response({:ok, %HTTPoison.Response{status_code: _, body: body}}),
    do: {:error, body}
end
